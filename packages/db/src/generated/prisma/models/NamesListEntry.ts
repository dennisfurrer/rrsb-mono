...
// @ts-nocheck 
/*
 * This file exports the `NamesListEntry` model and its related types.
 *
...
export type GetNamesListEntryAggregateType<T extends NamesListEntryAggregateArgs> = {
      [P in keyof T & keyof AggregateNamesListEntry]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNamesListEntry[P]>
    : Prisma.GetScalarType<T[P], AggregateNamesListEntry[P]>
}
...
type GetNamesListEntryGroupByPayload<T extends NamesListEntryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NamesListEntryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NamesListEntryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NamesListEntryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NamesListEntryGroupByOutputType[P]>
      }
    >
  >
...
export type NamesListEntryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NamesListEntryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NamesListEntryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NamesListEntry'], meta: { name: 'NamesListEntry' } }
  /**
   ...
   * })
  **/
  count<T extends NamesListEntryCountArgs>(
    args?: Prisma.Subset<T, NamesListEntryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NamesListEntryCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NamesListEntryGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NamesListEntryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNamesListEntryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
