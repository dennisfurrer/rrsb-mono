        ...
        <div className="sb-left" onClick={() => {
          ...
          >
            <div className="sb-name-with-club sb-name-with-club--left">
              ...
              <div className="sb-club-name" style={effP1Color ? { color: effP1Color } : undefined}>{p1.club || "Club?"}</div>
            </div>
            ...
            {onRemoteClick && !matchFinished && (
              <button
                ...
                style={{ position: "absolute", bottom: "calc(0.4vh + 1cm)", left: "0.8vw", background: "none", border: "none", cursor: "pointer", padding: 0, lineHeight: 0, opacity: 0.8, display: "flex", alignItems: "center" }}
              >
        ...
        <div className="sb-right" onClick={() => {
          ...
          >
            <div className="sb-name-with-club sb-name-with-club--right">
              ...
              <div className="sb-club-name" style={effP2Color ? { color: effP2Color } : undefined}>{p2.club || "Club?"}</div>
            </div>
            {noScores && !matchFinished && (
              <button
            ...
            {onRemoteClick && !matchFinished && (
              <button
                ...
                title="Fernbedienung (Handy)"
                style={{ position: "absolute", bottom: "calc(0.4vh + 1cm)", right: "0.8vw", background: "none", border: "none", cursor: "pointer", padding: 0, lineHeight: 0, opacity: 0.8, display: "flex", alignItems: "center" }}
              >
                {remoteConnected?.[1] && (
